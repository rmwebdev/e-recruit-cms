...
class SettingController extends Controller
{
   ...
   public function get_data_user(Request $request)
    ...
    {
		$data['role'] = \DB::select("select id, name from e_recruit.roles order by name asc");
        ...
        $data['parent_user'] = \App\Models\User::select('nip', 'name')
                        ->whereNotNull('name')
                        ->groupBy('nip', 'name')
                        ->orderby('name', 'asc')
                        ->get();
    ...
    public function store_user(Request $request)
    {
        ...
        else
        {
            ...
            $save->email_user = $request->email_user;
            $save->hp = $request->hp;
            $save->nip = $request->nip;
			$save->username = $request->nip;
            ...
            $save->parent_user = $request->parent_user;
			$save->role_id = $request->role_user;
