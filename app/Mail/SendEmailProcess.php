...
class SendEmailProcess extends Mailable
{
    ...
    {
        return $this->from('no-reply@puninar.com')->subject('Admin E-recruitment - Process recruitment candidate')
        ->markdown('emails.SendEmailProcess')
        ->with(
            [
                ...
                // 'invitation_process' => $this->candidate['invitation_process'],
