...
return [
    ...
    */
    ...
    'default' => env('DB_CONNECTION', 'erecruit-dev'),
    ...
    */
    ...
    'connections' => [
        ...
        'middleware' => [
            'driver' => 'pgsql',
            'host' => env('DB_HOST_2', 'middleware.puninar.com'),
            'port' => env('DB_PORT_2', '5432'),
            'database' => env('DB_DATABASE_2', 'midd_db'),
            'username' => env('DB_USERNAME_2', 'midddbms'),
            'password' => env('DB_PASSWORD_2', 'midddbms@puninar'),
            'charset' => 'utf8',
            //'prefix' => '',
            //'sslmode' => 'prefer',
        ],
