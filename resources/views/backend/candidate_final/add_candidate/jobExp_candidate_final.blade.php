<div class="col-12" style="">
  ...
  <div class="row">
    <label class="control-label"> <button class="btn btn-primary" type="button" onclick="addJobExp('{{$candidate_id}}')"> <i class="fa fa-plus"></i> Add Job Experience </button></label>
      ...
      <tbody>
        ...
        @foreach($jobExp as $job)
          <tr>
            ...
            <td>
              <input type="text" name="rowStartJobExp{{$job->job_exp_id}}"  maxlength="4" id="rowStartJobExp{{$job->job_exp_id}}" class="form-control number_valid" value="{{$job->start_job_exp}}"  disabled>
                <span class="invalid-feedback" role="alert"></span>
            </td>
            <td>
              <input type="text" name="rowEndJobExp{{$job->job_exp_id}}"  maxlength="4" id="rowEndJobExp{{$job->job_exp_id}}" class="form-control number_valid" value="{{$job->end_job_exp}}"  disabled>
                <span class="invalid-feedback" role="alert"></span>
            </td>
            <td>
...
<div class="col-12" style="">
  ...
  <div class="row">
    <label class="control-label"> <button class="btn btn-primary" type="button" onclick="addJobInterest('{{$candidate_id}}')"> <i class="fa fa-plus"></i> Add Job Interest </button></label>
        ...
        @foreach($jobInterest as $jobInt)
          <tr>
            ...
            <td>
              ...
              <input type="text" name="rowTypeOfWork{{$jobInt->job_interest_id}}" id="rowTypeOfWork{{$jobInt->job_interest_id}}" class="form-control" value="{{$jobInt->type_of_work}}" disabled>
                <span class="invalid-feedback" role="alert"></span>

            </td>
            <td>
              <input type="text" name="rowSort{{$jobInt->job_interest_id}}" id="rowSort{{$jobInt->job_interest_id}}" class="form-control number_valid" value="{{$jobInt->sort}}" disabled>
                <span class="invalid-feedback" role="alert"></span>
            </td>
