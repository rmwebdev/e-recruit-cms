        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="col-12" style="">
                  ...
                  <div class="row">
                    <label class="control-label"> <button class="btn btn-primary" type="button" onclick="addFamily('{{$candidate_id}}')"> <i class="fa fa-plus"></i> Add Family </button></label>
                ...
                <div class="col-12" style="">
                  ...
                  <div class="row">
                    <label class="control-label"> <button class="btn btn-primary" type="button" onclick="addEmergencyContact('{{$candidate_id}}')"> <i class="fa fa-plus"></i> Add Emergency Contact </button></label>
                      ...
                      <tbody>
                        ...
                        @foreach($emergency_contact as $emergency_cont)
                          <tr>
                            ...
                            <td>
                              <input type="text" name="rowEmergencyPhone{{$emergency_cont->emergency_contact_id}}" id="rowEmergencyPhone{{$emergency_cont->emergency_contact_id}}" class="form-control number_valid" value="{{$emergency_cont->emergency_phone}}"  disabled>
                                <span class="invalid-feedback" role="alert"></span>
                            </td>
