...
function hoverAdmin(param)
{
    ...
    if(param == "familyInfo" )
    {
        $("#familyInfoAdmin").addClass('active_card_family');
        $("#familyInfoAdmin").removeClass('no_active_card_family');


        $("#personalInfoAdmin").removeClass('active_card_personal');
        $("#personalInfoAdmin").addClass('no_active_card_personal');


        $("#eduBackAdmin").removeClass('active_educational_background');
        $("#eduBackAdmin").addClass('no_active_educational_background');

        $("#courseInfoAdmin").removeClass('active_course_info');
        $("#courseInfoAdmin").addClass('no_active_course_info');

        $("#langSkillAdmin").removeClass('active_lang_skill');
        $("#langSkillAdmin").addClass('no_active_lang_skill');

        $("#orgInfoAdmin").removeClass('active_org_info');
        $("#orgInfoAdmin").addClass('no_active_org_info');


        $("#jobExpAdmin").removeClass('active_job_exp');
        $("#jobExpAdmin").addClass('no_active_job_exp');


        $("#otherAdmin").removeClass('active_other');
        $("#otherAdmin").addClass('no_active_other');

    }
    else if(param == "eduBack")
    {

        $("#eduBackAdmin").addClass('active_educational_background');
        $("#eduBackAdmin").removeClass('no_active_educational_background');


        $("#familyInfoAdmin").removeClass('active_card_family');
        $("#familyInfoAdmin").addClass('no_active_card_family');
    ...
    else if(param == "jobExp")
    {
        ...
        $("#jobExpAdmin").addClass('active_job_exp');
        $("#jobExpAdmin").removeClass('no_active_job_exp');
    ...
    else if(param == "other")
    {
        ...
        $("#otherAdmin").addClass('active_other');
        $("#otherAdmin").removeClass('no_active_other');
    ...
    {
        $("#langSkillAdmin").addClass('active_lang_skill');
        $("#langSkillAdmin").removeClass('no_active_lang_skill');
    ...
    else if(param == "orgInfo")
    {
        ...
        $("#orgInfoAdmin").addClass('active_org_info');
        $("#orgInfoAdmin").removeClass('no_active_org_info');
    ...
    {
        $("#personalInfoAdmin").addClass('active_card_personal');
        $("#personalInfoAdmin").removeClass('no_active_card_personal');
    ...
    {
        $("#courseInfoAdmin").addClass('active_course_info');
        $("#courseInfoAdmin").removeClass('no_active_course_info');
...
function updateCandidate()
{
    ...
    $.ajax({
        url:'{{route('candidate-final.store')}}',
        dataType: "json",
        data: dataFile,
        type:'POST',
        headers: {
     ...
     .done(function(data) {
        ...
        .fail(function(data) {
            $('#candidate_data').addClass('show');
            $('#candidate_form').addClass('show');
...
{   
    ...
    var body  = '<tr>'+
          ...
          $.ajax({
                    url:'{{route('candidate-final.getDropDownFamily')}}',
                    type:'POST',
                     headers: {
                        'X-CSRF-TOKEN': '{{ csrf_token() }}'
                    },
...
function saveFamily(no,candidate_id)
{
    ...
    $.ajax({
        url:'{{route('candidate-final.saveFamily')}}',
        type:'POST',
...
function saveEmergencyContact(no,candidate_id)
{
	...
	$.ajax({
        url:'{{route('candidate-final.saveEmergencyContact')}}',
        type:'POST',
        data:{
            id_no:id_no,
...
function updateFamily(id,no)
{
    ...
    $.ajax({
        url:'{{route('candidate-final.updateFamily')}}',
        type:'POST',
...
function updateEmergencyContact(id,no)
{
	...
	$.ajax({
        url:'{{route('candidate-final.updateEmergencyContact')}}',
        type:'POST',
        data:{
...
function saveCourse(no,candidate_id)
{
    ...
    $.ajax({
        url:'{{route('candidate-final.saveCourse')}}',
        type:'POST',
...
function updateCourse(id,no)
{
    ...
    $.ajax({
        url:'{{route('candidate-final.updateCourse')}}',
        type:'POST',
...
function saveOrgInfo(no,candidate_id)
{
    ...
    $.ajax({
        url:'{{route('candidate-final.saveOrgInfo')}}',
        type:'POST',
...
function updateOrgInfo(id,no)
{
    ...
    $.ajax({
        url:'{{route('candidate-final.updateOrgInfo')}}',
        type:'POST',
...
function addLangSkill(candidate_id)
{
    ...
    var body  = '<tr>'+
          ...
          '<td><select name="language_name'+getSkill.no_langSkill+'" class="form-control">'+
              $.ajax({
                    url:'{{route('candidate-final.getDropDownSkill')}}',
                    type:'POST',
                     headers: {
                        'X-CSRF-TOKEN': '{{ csrf_token() }}'
                    },
...
function saveLangSkill(no,candidate_id)
{
    ...
    $.ajax({
        url:'{{route('candidate-final.saveLangSkill')}}',
        type:'POST',
...
function updateLangSkill(id,no)
{
    ...
    $.ajax({
        url:'{{route('candidate-final.updateLangSkill')}}',
        type:'POST',
...
function saveSkill(no,candidate_id)
{
    ...
    $.ajax({
        url:'{{route('candidate-final.saveSkill')}}',
        type:'POST',
...
function updateSkill(id,no)
{
    ...
    $.ajax({
        url:'{{route('candidate-final.updateSkill')}}',
        type:'POST',
...
function addEduBack(candidate_id)
{
    ...
    var body  = '<tr>'+
          ...
          $.ajax({
                    url:'{{route('candidate-final.getDropDownEducation')}}',
                    type:'POST',
                     headers: {
                        'X-CSRF-TOKEN': '{{ csrf_token() }}'
                    },
...
function saveEduBack(no,candidate_id)
{
    ...
    $.ajax({
        url:'{{route('candidate-final.saveEduBack')}}',
        type:'POST',
...
function updateEduBack(id,no)
{
    ...
    $.ajax({
        url:'{{route('candidate-final.updateEduBack')}}',
        type:'POST',
...
function addJobExp(candidate_id)
{
    ...
    var body  = '<tr>'+
          ...
          $.ajax({
                    url:'{{route('candidate-final.getDropJob')}}',
                    type:'POST',
                     headers: {
                        'X-CSRF-TOKEN': '{{ csrf_token() }}'
                    },
...
function saveJobExp(no,candidate_id)
{
    ...
    $.ajax({
        url:'{{route('candidate-final.saveJobExp')}}',
        type:'POST',
...
function saveJobInterest(no,candidate_id)
{
    ...
    $.ajax({
        url:'{{route('candidate-final.saveJobInterest')}}',
        type:'POST',
        data:{
...
function updateJobExp(id,no)
{
    ...
    $.ajax({
        url:'{{route('candidate-final.updateJobExp')}}',
        type:'POST',
...
function updateJobInterest(id,no)
{
    ...
    $.ajax({
        url:'{{route('candidate-final.updateJobInterest')}}',
        type:'POST',
...
{   
  ...
  $.ajax({
        ...
        url: "{{route('candidate-final.changePhoto')}}", 
        type: "POST",   
        data: dataFile, 
        dataType:'JSON',
        headers: {
...
function changeCV(input)
{
    ...
    $.ajax({
        ...
        url: "{{route('candidate-final.changeCV')}}", 
        type: "POST",   
        data: dataFile, 
        dataType:'JSON',
        headers: {
