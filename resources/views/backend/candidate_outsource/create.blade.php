...
<!-- 								<div class="form-group">
							  	...
							  	<div class="form-group">
							    	...
							    	<select class="form-control   validate" name="request_reason" id="request_reason" onchange="get_reason(this)">
						    ...
						    <div class="col-md-6">
						    	...
						    	<br>
							 	...
							 	<div class="form-group">
							  	...
							  	<div class="form-group">
								    <label for="exampleInputEmail1" style="margin-bottom: 15px">SUBCO <span class="span-mandatory">*</span></label>
