                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <!-- <input type="text" name="ass_name" class="form-control number_valid_char" value="Nama" readonly> -->
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">NPK <span class="span-mandatory">*</span> </label>
                                        <input class="form-control" type="text" name="no_npk" readonly id="no_npk" value="{{$get_data->history->no_npk}}" >
                                        <i class="invalid-feedback" role="alert"></i>    
                                    </div>

                                     <div class="form-group">
                                        <label for="exampleInputPassword1">Gender <span class="span-mandatory">*</span> </label>
                                         <input class="form-control" type="text" name="gender" readonly id="gender" value="{{$get_data->history->gender}}" >
                                        <i class="invalid-feedback" role="alert"></i>    
                                    </div>

                                     <div class="form-group">
                                        <label for="exampleInputPassword1">No KTP <span class="span-mandatory">*</span> </label>
                                ...
                                @if($get_data->job_fptk->employment_type != 'magang')
                                
                                  <div class="form-group">
                                    <label class="control-label  font-14"> PT OS   </label>
                                    <input class="form-control" type="text" name="other_project"  id="other_project" readonly value="{{$get_data->company_name}}">
                                    <i class="invalid-feedback" role="alert"></i>                                 
                                  </div>
                                ...
                                @endif
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="ass_tgl_penilaian" class="form-control datepicker3" readonly value="{{Carbon\Carbon::now()}}">
                                        <i class="invalid-feedback" role="alert"></i>
                                    </div>
                                </div>
                            </div>
