        	...
        	<nav class="navbar bg-white" style="height: 55px;border-radius: 5px;">
	          <div class="row">
	            <div class="col-12">
	                ...
	                <h3 class="color-ungu  pl-3 mt-1 font-18 font-weight-900"> <a href="{{url('rec-process')}}"> <i class="fa fa-arrow-left"></i> </a>  {{ strtoupper($editData->position_name) }} </h3>   
	            </div>
	          </div>
	                  	...
	                  	<div class="section">
							...
							<div class="col-md-6">
									...
									<div class="form-group">
										...
										<textarea type="text" name="" rows="4" readonly class="form-control">{{$editData->reason_hiring}}</textarea>
									</div>
	              		...
	              		<div class="row">
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									...
									<textarea type="text" name="" rows="4"  readonly class="form-control">{{$editData->additional_information}}</textarea>
								</div>
	              	...
	              	<div class="row">
	              		<div class="col-md-12">
	              			<form  id="form-job">
		              			...
		              			<div class="form-group">
									<label for="" class="control-label font-14"> <strong>DROP</strong>   </label>
		              			...
		              			<div class="form-group">
									<label for="" class="control-label font-14"> <strong>SUBCO</strong> </label>
									<select name="subco" class="form-control" id="subco" required="required">
										<option value=""> === SELECT SUBCO   === </option>
										<option value="yes" {{( $editData->subco == 'yes') ? "selected" : "" }} >Yes</option>
										<option value="no"  {{( $editData->subco == 'no') ? "selected" : "" }} >No</option>				
									</select>
									<span class="invalid-feedback" role="alert"></span>
		              			</div>

		              			<div class="form-group" id="row_drop" style="display: {{($editData->drop == 'yes' ? "" : "none")}};">
									<label for="" class="control-label font-14"> <strong>REASON DROP</strong> <span class="span-mandatory">* </span>  </label>
									<textarea name="reason_drop" id="reason_drop" class="form-control">{{(!empty($editData->reason_drop)) ? $editData->reason_drop : "" }}</textarea>
									<span class="invalid-feedback" role="alert"></span>
		              			</div>
