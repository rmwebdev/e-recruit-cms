                          ...
                          <tbody>
                            ...
                            @foreach($data as $banner)
                              <tr>
                                ...
                                <td><a class="btn" onclick="edit_setting_banner('{{$banner->setting_banner_id}}')" href="#"><i class="fa fa-edit"></i></a> | <a onclick="delete_setting_banner('{{$banner->setting_banner_id}}')" href="#" class="btn"><i class="fa fa-trash-o"></i> </a></td>
                              </tr>
                              @php
                                $no++;
                              @endphp
      ...
      <div class="modal-body">
        <form id="form-setting-banner">
            <div class="form-group row">
               <label for="" class="col-sm-2 col-form-label"> Nama Banner : <span class="span-mandatory">*</span> </label>
              <div class="col-sm-9">
          ...
          <div class="form-group row">
            <label for="" class="col-sm-2 col-form-label">Keterangan Banner : <span class="span-mandatory">*</span> </label>
            <div class="col-sm-9">
          ...
          <div class="form-group row">
            <label for="" class="col-sm-2 col-form-label">Tipe  Foto : <span class="span-mandatory">*</span> </label>
            <div class="col-sm-9">
                <select class="validate form-control" id="setting_banner_type"  name="setting_banner_type" >
                  <option value="banner"> Banner </option>
                  <option value="warning"> Pemberitahuan </option>
                </select>
                <i class="invalid-feedback" role="alert"></i>  
            </div>
          </div>
          ...
          <div class="form-group row">
              <label for="" class="col-sm-2 col-form-label">Foto Banner : <span class="span-mandatory">*</span> </label>
              <div class="col-sm-9">
