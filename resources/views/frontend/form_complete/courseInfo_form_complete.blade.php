<div class="col-12" style="">
  <div class="row">
    <h4 class="font-20">COURSE INFORMATION</h4>
  </div>
  <div class="row mt-3">
    <label class="control-label"> <button class="btn btn-primary" type="button" onclick="addCourse()"> <i class="fa fa-plus"></i> ADD COURSE </button></label>
      ...
      <tbody>
        ...
        @foreach($courseInfo as $course)
          <tr>
            ...
            <td>
              <input type="text" name="rowStartYear{{$course->course_info_id}}" maxlength="4" id="rowStartYear{{$course->course_info_id}}" class="form-control number_valid_char" value="{{$course->start_year}}"  disabled>
                <span class="invalid-feedback" role="alert"></span>
            </td>
            <td>
              <input type="text" name="rowEndYear{{$course->course_info_id}}" maxlength="4" id="rowEndYear{{$course->course_info_id}}" class="form-control number_valid_char" value="{{$course->end_year}}"  disabled>
                <span class="invalid-feedback" role="alert"></span>
            </td>
