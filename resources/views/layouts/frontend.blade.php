...
<div class="loading" style="display: none;">
  <img src="{{asset('images/loading.gif')}}"> 
    ...
    <nav class="navbar navbar-expand-md fixed-top bg-white shadow-sm p-3 mb-5 bg-white rounded" style="height: 50px;">
      <div class="container">
        <a class="navbar-brand" href="{{url('/to_other_url?type=website')}}" style="margin-top: -7px;z-index: 1;">
          <img src="{{asset('images/logo-puninar.png')}}">
        </a>
        ...
        <div class="collapse navbar-collapse " id="navbarResponsive" style="width: 100%; background-color:#FFFFFF; margin: 0 -20px;">
        ...
        <div class="row">
            <div class="col-md-9  color-pun-abu">
              ...
              <div class="col-md-9 pl-0 mt-3">
                ...
                <br>
                <img src="{{asset('images/wa_footer.png')}}"> Phone : +62 21 460 2278 (Hunting) <br> 
...
<!--             <div style="text-align: right;">
              <button onclick="closeModalWarning()" type="button" style="background-color: white; border-color: #909090; color:#000">
               <span aria-hidden="true"  >&times;</span> 
              </button>
            </div>
...
<div class="modal fade" id="modalRegistration" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="false" data-backdrop="static">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-body">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <div class="ml-5">
                  <form id="form-registration">
                    ...
                    <div class="form-group mt-5">
                      <div class="col-md-11">      
                        <div class="clearfix">
                          <button type="button" id="closeBtnRegis"  class="btn bg-white pull-left" style="width: 100px;" onclick="closeModalRegistration()">Cancel</button>
                          <button type="submit"  id="saveBtnRegis" class="btn  pull-right bg-pun-orange color-white" style="width: 100px">Register</button>
                        </div>
                      </div>
                    </div>
                </form>
